  ...
  return (
    <main>
      <header>
        ...
        <p>
          Runs and ingestion overview. <Link to="/optimization">Open optimization panel</Link> | <Link to="/batches">Open batch analytics</Link> | <Link to="/simulations">Open simulation launcher</Link> | <Link to="/intake">Open strategy intake</Link> | <Link to="/workflow">Open workflow board</Link>
        </p>
      </header>
